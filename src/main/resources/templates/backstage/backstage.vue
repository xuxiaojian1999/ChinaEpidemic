...
<script>
//疫情数据组件
import provincelist from '@/main/resources/templates/backstage/province_list.vue'
// 更新播报组件
import broadcastlist from '@/main/resources/templates/backstage/broadcast_list.vue'
//账号管理组件
import admin from '@/main/resources/templates/backstage/admin.vue'
...
export default {
  ...
  methods:{
    //注销
    logout(){
      //移除localStorage中的backstageUser
      //在backstage.js中添加和获取backstageUser
